...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Montir</h2>
            <p class="text-gray-500 dark:text-gray-400 text-sm">Registrasi montir baru</p>
        </div>
        ...
        <div class="p-6">
            <form action="{{ route('mechanics.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" placeholder="Nama Montir" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="specialization" placeholder="Contoh: Mesin, Kelistrikan"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 text-gray-800 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition placeholder-gray-400">
                    </div>
                </div>
