...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Kendaraan</h2>
            <p class="text-gray-500 dark:text-gray-400 text-sm">Registrasi kendaraan baru</p>
        </div>
            ...
            <form action="{{ route('vehicles.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 text-right">
                        <a href="{{ route('customers.create') }}" class="text-xs text-orange-600 hover:text-orange-700 font-medium">
                            + Buat Pelanggan Baru
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" placeholder="Contoh: Vario 150 Hitam" required
                    ...
                    <div>
                        ...
                        <input type="text" name="plate_number" placeholder="DA 1234 XX"
