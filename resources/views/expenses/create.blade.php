...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Catat Pengeluaran</h2>
            <p class="text-gray-500 dark:text-gray-400 text-sm">Input biaya operasional baru</p>
        </div>
        ...
        <div class="p-6">
            <form action="{{ route('expenses.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="description" placeholder="Contoh: Beli Token Listrik, Makan Siang Karyawan" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="amount" placeholder="0" required min="0"
                ...
                <div>
                    ...
                    <input type="text" name="category" placeholder="Contoh: Listrik, Konsumsi, Tools" list="categories"
                        class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 text-gray-800 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition placeholder-gray-400">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" placeholder="Keterangan lebih detail..."
